...
| `scrapline/` | SCRAPLINE 0.1。車列の順番で一つの鉄塊を変える7区画の縦切り |
...
- [research/fun_beyond_difficulty_2026-08-26.md](./research/fun_beyond_difficulty_2026-08-26.md) — 難易度・複雑さ以外の体験エンジン、既存ゲーム比較、未使用手段
...
作者2ランの結果は2/2勝利、10/10区画通過。seed12は面白さ3/5・再プレイ度3/5、ランダムseed181104049は2/5・2/5で「簡単すぎ」だった。後者は初期構成だけで後半2区画を見送っても勝利した。

自動ゲートは5/5だったが、これは面白さの合格ではない。0.1は、初期に型ができると選択が消える、交換の損失がない、抽象資源の意味が伝わりにくい、最終ログが消える、という理由で不採択。次の仮説と観測は [analysis/EMBERLINE_0_1.md](./analysis/EMBERLINE_0_1.md) の末尾に記録している。
