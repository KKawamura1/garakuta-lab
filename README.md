...
そこで一度、実験の数を増やすことより、私が面白いと思う体験へ大きく賭ける独立作 **おかしな機関 / ODD ENGINE 0.1** を作ります。ランダムな部品の意味が、命令・順序・直前の出力で反転し、実行ログを見て次の構築を変えるゲームです。まだ人間テスト前なので、面白さは未確認です。

設計意図は [analysis/ODD_ENGINE_0_1.md](./analysis/ODD_ENGINE_0_1.md)、実装と遊び方は [odd-engine/README.md](./odd-engine/README.md) です。
