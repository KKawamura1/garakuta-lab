// laws-0.5「法則機関」— 1つの良い問題ではなく、問題を生む機械。
//
// 版の正本と変更履歴は core/rules-version.mjs。現在は単調・減衰をランから外し、
// 短い「破れ」の出題にだけ残している。
//
// 【0.1 からの主な変更】規則が実質変わるたび版を上げる。**版を据え置くと記録が混ざる。**
...
- **この版の得点は「連勝」である。**触らずに次も勝てるなら、
  構築画面に「飛ばす」が出る。押せばその戦闘を飛ばして連勝が1増える。
  **押さずに拾い物を枠に入れれば強くなるが、次に手で戦った時点で連勝は切れる。**
  伸ばすか、強くするか。**毎回選ぶ。**
