...
const activeMeta = {
  ...
  aimed_shot: ["狙い撃ち", "最も弱った敵へ技術125%。技なので後列から出しても落ちず、前列が生きていても後列へ通る。", "攻撃"],
  bulwark: ["防壁形成", "自分に技術の200%のラウンド防壁を張ってから、追い打ちを行う。", "守り"],
  ...
  shield_the_wounded: ["傷へ盾を", "最も傷ついた味方へ技術の150%のラウンド防壁を張ってから、追い打ちを行う。", "支援"],
  ...
  shield_wall: ["盾の列", "前列の味方**全員**へ技術70%のラウンド防壁。一人へ厚く張る「傷へ盾を」の面展開。", "守り"],
  rally_line: ["陣を組み直す", "最も傷ついた前衛と、最も無事な後衛（自分以外）を入れ替える。自分は動かない。", "機動"],
  bulwark_of_will: ["意地の壁", "**開幕2ラウンドだけ**、自分へ最大HPの10%の戦闘中防壁。技術ではなく体で張る。", "守り"],
  ...
  field_dressing: ["まとめて手当て", "HP50%以下の味方**全員**へ技術60%のラウンド防壁。対象がいなければスキップ。", "支援"],
  steady_breath: ["息を合わせる", "隊列の最後の味方へ「集中」を1つ。狙いを澄ますを他人へ向けた形。", "支援"],
  ward_ally: ["守勢を渡す", "最も傷ついた味方へ「守勢」を1つ。防壁と違い削り切られず、一撃ごとに8軽くする。", "支援"],
  precise_cut: ["静かな一手", "このラウンド一度も被弾していないときだけ、技術150%。技なので後列からでも落ちない。", "攻撃"],
  sustaining_ward: ["長く守る", "**開幕2ラウンドだけ**、最も傷ついた味方へ技術90%の戦闘中防壁。薄いが消えない。", "支援"],
  ...
  feint: ["誘い", "最前の敵へ「怯み」を1つ。先に動く相手ほど軽くする価値がある。", "指揮"],
  set_the_pace: ["拍を作る", "準備1回のあと、行動権を1と「集中」を1。開始と準備で2つ払うので手数は増えない。", "準備"],
  // 連撃と刻印（pack_barrage）— 刻印を「数」として読む
  flurry_finish: ["刻み止め", "最も弱った敵へ30%を5回。受け構えを剥がしやすく、受けの厚い相手には最も弱い。", "攻撃"],
  mark_spread: ["刻印を散らす", "「隙」を持たない敵**全員**へ隙を1つずつ配る。対象がいなければスキップ。", "攻撃"],
  shatter_point: ["積もる刻印", "「隙」1段につき45を受け無視で叩き込み、隙を全部刈り取る。腕力も技術も読まない。", "攻撃"],
...
const reactiveMeta = {
  ...
  guard_step: ["踏み固め", "移動したあと、技術の50%のラウンド防壁を得る。", "移動"],
  ...
  barrier_bloom: ["防壁の花", "防壁を得たとき、さらに技術の25%の防壁。", "防壁"],
  ...
  wake_of_the_fallen: ["倒したあと", "敵が倒れたあと、RP1で最も傷ついた味方へ技術の100%の防壁。", "撃破"],
  // R9 §4.1 / §9.2 — 導入 pack の接続面。別の役割が使う小さな入口と出口。
  whetted_by_pain: ["痛みで研ぐ", "被弾したあと、RP1で「集中」を得る。守り役が刃のpackへ入る口。", "被弾"],
  shield_handoff: ["受けの受け渡し", "受け構えで一撃を止めたあと、RP1で最も傷ついた味方へ技術の75%の防壁。", "防御"],
  ...
  last_stand: ["背水", "被弾してHP30%以下になったとき、RP1で技術150%のラウンド防壁。戦闘に1回きり。", "被弾"],
  counterweight: ["支え直す", "**自分以外の味方**が動いたあと、RP1でその味方へ技術50%のラウンド防壁。", "移動"],
