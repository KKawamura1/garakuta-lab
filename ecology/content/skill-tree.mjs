...
const activeMeta = {
  ...
  row_sweep: ["薙ぎ払い", "前列の敵が2体以上いるとき、同じ行を80%ずつ薙ぐ。1体なら通常攻撃へ戻る。", "攻撃"],
  column_thrust: ["突き通し", "同じ列の前後を110%ずつ貫く。後列を庇う列に効く。", "攻撃"],
  guard_crush: ["受け崩し", "通常攻撃を上回る115%。相手の受け構えと受けを完全に無視する。", "攻撃"],
  rear_hunt: ["後衛狩り", "後列の生存者だけを120%で狙う。後列がいないときは通常攻撃へ戻る。", "攻撃"],
  finishing_thrust: ["止めの一突き", "HP半分以下の敵だけを140%で狙う。条件なしでは通常攻撃へ戻る。", "攻撃"],
  crack_mark: ["傷口を開く", "未露出の敵へ110%で攻撃し、「隙」を付ける。すでに隙があれば通常攻撃へ戻る。", "攻撃"],
  brace_for_impact: ["衝撃に備える", "受け構えを1つ得てから、通常の追い打ちを行う。多段攻撃には剥がされやすい。", "守り"],
  strike: ["斬撃", "最も弱った敵へ、通常攻撃を上回る120%の単発。", "攻撃"],
  mend: ["手当て", "傷ついた味方を100%回復。負傷者がいなければ通常攻撃へ戻る。", "支援"],
  bulwark: ["防壁形成", "自分に80%相当のラウンド防壁を張ってから、追い打ちを行う。", "守り"],
  relay_order: ["号令", "前衛の最速の味方へ行動権を1渡す。", "指揮"],
  heavy_swing: ["溜め突き", "準備1回のあと、通常攻撃2回分を上回る220%の一撃。", "攻撃"],
  reposition: ["位置替え", "後衛なら、最も傷ついた前衛と場所を替える。", "機動"],
  long_swing: ["大溜め", "準備3回のあと、通常攻撃4回分の400%を一撃で返す。", "攻撃"],
  triage: ["応急手当", "HP半分以下の味方を100%回復。条件なしでは通常攻撃へ戻る。", "支援"],
  hunt_the_slow: ["準備狩り", "準備中の敵へ120%の一撃。いなければ次の攻撃へ進む。", "攻撃"],
  idle_shuffle: ["息を整える", "自分に集中を1つ付ける。集中中は使わない。", "準備"],
  mark_target: ["隙を刻む", "まだ「隙」のない敵に付与する。全員に隙があれば通常攻撃へ戻る。", "指揮"],
  steady_aim: ["狙いを澄ます", "自分に「集中」を1つ付けてから、追い打ちを行う。集中中は通常攻撃。", "準備"],
};
...
const equipmentMeta = {
  ...
  block_latch: ["受け止め金具", "戦闘開始時、戦闘中防壁1を得る。耐久2。", "防御", 2],
  impact_spring: ["衝撃ばね", "受け構えが消費されたあと、耐久1でラウンド防壁1を得る。", "防御", 1],
