...
export const DIALOGUE = Object.freeze({
  ...
  stage_1_join: Object.freeze({
    ...
    lines: Object.freeze([
      ...
      say("lancer", "置いたら、結局は誰かが持つことになるので。……それで、話って何ですか。嫌な予感しかしないんですけど。", "worry"),
      say("warden", "灰の門の先まで行く。二人だと前が足りねえ。お前が三発ぶん立っててくれりゃ、それでいい。削るのはツグミがやる。", "smile"),
      say("lancer", "えっ。あの、わたしですか。わたし、押し返すだけで、倒せた試しが無いんですけど……。それに三発って、なんですか三発って。数え方がもう嫌です。", "shock"),
      say("mender", "傷は診ます。ただし、塞げるのは開いたばかりのものだけです。古いのは、もう体のかたちになっているので。", "calm"),
  ...
  stage_3_join: Object.freeze({
    ...
    lines: Object.freeze([
      ...
      say("warden", "……じいさん、どっから入った。鍵かけたよな？ かけた。俺がかけた。かけたはずだ。", "shock"),
