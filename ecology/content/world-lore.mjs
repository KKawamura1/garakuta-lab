...
const HOMESTEAD_FIXTURE_LORE_RAW = {
  ...
  ledger: {
    label: "帳簿と目録",
    lines: [
    "ゴウの帳簿。借りた器材、返した器材、残った借り。数字しか書いていない。",
  ...
  records: {
    label: "体調の記録",
    lines: [
    "ツグミの記録帳。誰が何時間寝たか、何を食べたか、腕がどこまで上がるか。",
    "訊くと「業務です」と言う。訊かなければ何も言わない。",
  ],
  },
  hearth: {
    label: "朝の火",
    ...
    "ナギは火の番が長い。誰も代わると言わないので、そのまま座っている。",
  ],
  },
  shelf: {
    label: "棚",
    lines: [
    "ナギが拾ってきた物が並んでいる。割れた把手、色の褪せた札、片方だけの留め金。",
  ...
  blueprint_wall: {
    ...
    "形のほうを残しておく。ゲンゾウが言い出して、ゴウが場所を空けた。",
  ],
  },
  empty_seat: {
    label: "空いた席",
