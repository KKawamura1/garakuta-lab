...
function schemaValidDefinitionFixture(nodeKey) {
...
const outOfScopeRegistry = {
  ...
  entries: {
    ...
    [nonInitialNodeKey]: {
      ...
      definition: schemaValidDefinitionFixture(nonInitialNodeKey),
    },
  },
};
...
const medicalRegistry = makeWeaponSkillRuntimeRegistry({
  [medicalA1]: schemaValidDefinitionFixture(medicalA1),
});
...
const withUnselectedPack = makeWeaponSkillRuntimeRegistry({
  ...definitions,
  "gauntlets:R": schemaValidDefinitionFixture("gauntlets:R"),
});
