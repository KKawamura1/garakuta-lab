...
集中・怯み・高揚・隙・守勢・堅牢・破甲・裂傷・再生・移動不能・誘引・受け構え・観測・集中標・連携・仕込み・借り・準備の18種類を用いる。
全種類の上限を6段で共通化し、連携だけは大量蓄積を残して300段とする。個々の意味、消費、持続はカタログ0.3節を正本とする。観測・集中標は敵に付く弱体、準備は中立の状態である。
...
観測は味方全員で共有し、攻撃可能ならその敵一体を各人の攻撃主軸のターゲット規則より先に選ぶ。攻撃主軸一回の解決後に1段減り、多段・範囲でも一度だけ減る。追撃・反撃では減らない。別の敵へ付けると旧観測を消し、観測対象が攻撃不能なら段を消費せず各人の規則へ進む。集中標は付与者個人の与ダメージ条件であり、ターゲットを上書きしない。
