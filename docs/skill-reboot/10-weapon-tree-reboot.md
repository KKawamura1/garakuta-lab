...
個々の意味、上限、消費、持続はカタログ0.3節を正本とする。観測・集中標は敵に付く弱体、準備は中立の状態である。
...
長時間効果は段ごとに3ラウンド続き、再付与で古い段の期限を更新しない。最大段数まで重ねられる。
盾役は複数回攻撃を受けるため、守勢1の被ダメージ軽減は3%、堅牢1の受け上昇は各hitで+1とし、
集中1の次の主軸+30%より低い割合を選ぶ。数値は戦闘標本で検証する。
...
観測は味方全員で共有し、攻撃可能ならその敵一体を各人のターゲット規則より先に選ぶ。別の敵へ付けると旧観測を消し、同じ敵への追加は期間を1段ぶん増やす。観測対象が攻撃不能なら各人の規則へ進む。集中標は付与者個人の与ダメージ条件であり、ターゲットを上書きしない。
