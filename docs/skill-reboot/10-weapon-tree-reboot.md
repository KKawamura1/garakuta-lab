...
見取り・重ね構えは強化なら種類を問わず1段、再生だけは2段追加でき、無手は連携も含め最大6段を消費する。
...
盾役は複数回攻撃を受けるため、守勢1の被ダメージ軽減は2%、堅牢1の受け上昇は各hitで+1とし、
集中1の次の主軸+30%より低い割合を選ぶ。怯みは1段-15%で、6段でも主軸を完全停止しない。再生は終了時に残った1段につき次の開始時に固定の防壁5。再生を一度に付ける場合は最低2段。数値は戦闘標本で検証する。
