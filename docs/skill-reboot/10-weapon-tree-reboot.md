...
| ルート | 能力と面白さ | 強み | 弱み |
|---|---|---|---|
| A→AA：持続救護 | リアクティブ単体回復＋RP2のリアクティブ全体回復で、受けた傷を次の被弾まで戻す。 | 多人数被弾に強い。 | 即死級の一撃に弱く、回復後のHPが次戦闘へ響きやすい。 |
| A→AB：一点救命 | 単体回復を残し、HP条件を緩めて早い段階から救う。 | 単体攻撃・集中攻撃に強い。 | 全体攻撃では一人ずつしか救えず、回復が追いつきにくい。 |
| B→BA：防壁陣 | 一列防壁から全体防壁・再生へ広げる。 | 安定性が高く、通常戦闘に強い。 | 防壁貫通、固定ダメージ、防壁を消す攻撃に弱い。 |
| B→BB：残壁治療 | ラウンド末に残存防壁をHPへ回し、戦闘終了時にも回復する。一列150%防壁も使える。 | 雑魚連戦と小ダメージの蓄積に強い。 | 大技では防壁を失い、ボス戦の瞬間耐久は防壁陣に劣る。 |

BB1の回復にはRP2、BB2の回復には費用がない。anti-stallのような内部の回復上限は表示文へ持ち込まず、通常のHP回復処理へ任せる。
